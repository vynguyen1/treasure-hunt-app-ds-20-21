...
class TreasureHunts: ObservableObject {
    ...
    @Published var treasureHunts: [TreasureHunt] = [
        TreasureHunt(name: "Test Schnitzeljagd",
                     ...
                     checkpoints: [Checkpoint(name: "Home", hint: "Hier wohnst du.",
                                              coordinate: CLLocationCoordinate2D(latitude: 52.39949, longitude: 8.006106),
                                              checked: true),
                    Checkpoint(name: "Kreuzung", hint: "Hier steht ein Briefkasten",
                               coordinate: CLLocationCoordinate2D(latitude: 52.398325, longitude: 8.001591)),
                    Checkpoint(name: "Kanal", hint: "Hier gibt's viel Wasser!",
                               coordinate: CLLocationCoordinate2D(latitude: 52.399924, longitude: 8.003733))]),
        TreasureHunt(name: "Test 2", description: "asdfghjkl. Dies ist ein zweiter Test Hunt. Beschreibung folgt.",
                     checkpoints: [Checkpoint(name: "Test", hint: "Test hint",
